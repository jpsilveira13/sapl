                    ...
                    <div class="text-center">
                        ...
                        <a href="{{route('orgao.create')}}"
                           class="btn btn-primary iframe"><span
                                    class="glyphicon glyphicon-plus-sign"></span> Novo Orgão
                        </a>
                ...
                <div class="x_panel">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#modalidades"><i class="fa fa-file-text-o" aria-hidden="true"></i> Orgãos</a>
                            </li>
                        ...
                        <div id="modalidades" class="tab-pane fade in active">
                            <div class="row">
                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                        ...
                                        <div class="table-responsive-vertical shadow-z-1">
                                            ...
                                            <table id="tabela" class="table table-hover table-striped">
                                                ...
                                                @foreach($orgaos as $orgao)
                                                    ...
                                                    <tr>
                                                        <td data-title="ID">{{$orgao->id}}</td>
                                                        <td class="vertical-middle" data-title="Nome">{{$orgao->nome}}</td>

                                                        <td data-title="Data de criação">{{ date("d/m/Y", strtotime($orgao->created_at)) }}</td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu mudar-posicao pull-right">
                                                                        <li>
                                                                            <a href="{{route('orgao.edit',['id'=> $orgao->id])}}"><i class="fa fa-fw fa-gear"></i>Ver mais</a>
                                                                        </li>
                                                                        <li class="divider"></li>
                                                                        <li>
                                                                            <a href="{{route('orgao.delete',['id'=> $orgao->id])}}"><i class="fa fa-trash-o" aria-hidden="true"></i> Deletar</a>
                                                                        </li>
                                                                        <li class="divider"></li>
                                                                        <li>
                                    ...
                                    @else
                                        <h2 class="text jumbotron">Não há orgão cadastrado!</h2>
                                    @endif
                                </div>
                            </div>
                        </div>
