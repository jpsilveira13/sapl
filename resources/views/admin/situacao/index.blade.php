                    ...
                    <div class="text-center">
                        ...
                        <a href="{{route('situacao.create')}}"
                           class="btn btn-primary iframe"><span
                                    class="glyphicon glyphicon-plus-sign"></span> Nova Situação
                        </a>
                ...
                <div class="x_panel">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#modalidades"><i class="fa fa-file-text-o" aria-hidden="true"></i> Situações</a>
                            </li>
                                        ...
                                        <div class="table-responsive-vertical shadow-z-1">
                                            ...
                                            <table id="tabela" class="table table-hover table-striped">
                                                ...
                                                @foreach($situacoes as $situacao)
                                                    ...
                                                    <tr>
                                                        <td data-title="ID">{{$situacao->id}}</td>
                                                        <td class="vertical-middle" data-title="Nome">{{$situacao->nome}}</td>

                                                        <td data-title="Data de criação">{{ date("d/m/Y", strtotime($situacao->created_at)) }}</td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu mudar-posicao pull-right">
                                                                        <li>
                                                                            <a href="{{route('situacao.edit',['id'=> $situacao->id])}}"><i class="fa fa-fw fa-gear"></i>Ver mais</a>
                                                                        </li>
                                                                        <li class="divider"></li>
                                                                        <li>
                                                                            <a href="{{route('situacao.delete',['id'=> $situacao->id])}}"><i class="fa fa-trash-o" aria-hidden="true"></i> Deletar</a>
                                                                        </li>
                                                                        <li class="divider"></li>
                                                                        <li>
