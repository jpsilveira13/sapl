...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Nova Licitação<small></small></h2>
            ...
            <div class="x_content">
                ...
                <form id="form1" action="{{route('licitacao.store')}}" method="post" role="form" accept-charset="UTF-8"  class="form-group">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
                        ...
                        <input type="text" id="titulo" name="titulo" value="{{old('titulo')}}" autofocus class="form form-control col-md-7 col-xs-12">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 form-group{{ $errors->has('numero_processo') ? ' has-error' : '' }}">
                        <div class="form-group">
                            ...
                            <input type="text" class="form form-control col-md-7 col-xs-12" name="numero_processo">
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 form-group{{ $errors->has('data_abertura') ? ' has-error' : '' }}">
                        <div class="form-group">
                            <label class="control-label">Data de Abertura:</label>
                                ...
                                <input type="text" maxlength="10" id="myDate" onkeypress="mascara(this,mdata)"  class="form form-control col-md-7 col-xs-12" name="data_abertura">
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 form-group{{ $errors->has('orgao_id') ? ' has-error' : '' }}">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 form-group{{ $errors->has('local') ? ' has-error' : '' }}">
                        <div class="form-group">
                            ...
                            <input type="text" id="myDate"   class="form form-control col-md-7 col-xs-12" name="local">
                        </div>
                        @if ($errors->has('local'))
                            <span class="help-block">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 form-group{{ $errors->has('data_publicacao') ? ' has-error' : '' }}">
                        <div class="form-group">
                            <label class="control-label">Data de Publicação:</label>
                                ...
                                <input  type="text" maxlength="10" id="myDate" onkeypress="mascara(this,mdata)"  class="form form-control col-md-7 col-xs-12" name="data_publicacao">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group{{ $errors->has('comunicado') ? ' has-error' : '' }}">
                        ...
                        <textarea id="titulo" rows="5" name="comunicado" value="{{old('comunicado')}}" autofocus class="form form-control col-md-7 col-xs-12"></textarea>
                        @if ($errors->has('titulo'))
                            <span class="help-block">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group{{ $errors->has('objeto') ? ' has-error' : '' }}">
                        <label>Objeto</label>
                        <textarea id="objeto" rows="5" name="objeto" value="{{old('objeto')}}" autofocus class="form form-control col-md-7 col-xs-12"></textarea>
                        @if ($errors->has('titulo'))
                            <span class="help-block">
