...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Novo documento da Licitação: {{$licitacao->titulo}}<small></small></h2>
            ...
            <div class="x_content">
                ...
                <form id="form1" action="{{route('licitacao.documento.store',['id'=>$licitacao->id])}}" enctype="multipart/form-data" method="post" role="form" accept-charset="UTF-8"  class="form-group">
                        ...
                        <div class="file-upload">
                            ...
                            <div class="file-upload-content" style="display: none;">
                                ...
                                <div class="image-title-wrap">
                                    <button type="button" onclick="removeUpload()" class="remove-image">Remover <span class="image-title">boleto_site.pdf</span></button>
                                </div>
                            </div>
                            <br>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
                        <div class="form-group">
                            ...
                            <input type="text"   class="form form-control col-md-7 col-xs-12" name="titulo">
                        </div>
